...
public class PanelAction extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdEdit.setIcon(new ImageIcon(PanelAction.class.getResource("/Imagens/Update (2).png"))); // NOI18N

        cmdDelete.setIcon(new ImageIcon(PanelAction.class.getResource("/Imagens/lixeira.png"))); // NOI18N

        cmdView.setIcon(new ImageIcon(PanelAction.class.getResource("/Imagens/View.png"))); // NOI18N
